...
const addRecord = async (req, res) => {
    ...
    try {
        const { amount, type, category, notes, transactionDate ,userId} = req.body;
...
// getAllRecords - GET /api/trans/all?type=expense&category=food&startDate=2026-04-01&endDate=2026-04-04&page=1&limit=10
